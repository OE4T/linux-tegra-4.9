...
static __initdata struct tegra_bpmp_clk_init tegra186_clocks[] = {
	...
	{ .clk_num = TEGRA186_CLK_GPCCLK, .name = "gpcclk" },
	...
	{ .clk_num = TEGRA186_CLK_UTMIP_PLL_PWRSEQ, .name = "utmip_pll_pwrseq" },
	{ .clk_num = TEGRA186_CLK_PEX_USB_PAD0_MGMT, .name = "pex_usb_pad0_mgmt" },
	{ .clk_num = TEGRA186_CLK_PEX_USB_PAD1_MGMT, .name = "pex_usb_pad1_mgmt" },
	...
	{ .clk_num = TEGRA186_CLK_PLLREFE_IDDQ, .name = "pll_refe_iddq" },
	{ .clk_num = TEGRA186_CLK_PLLE_PWRSEQ, .name = "plle_pwrseq" },
};
