...
#define TEGRA_SE_PKA1_CTRL_SE_INT_MASK_OFFSET	0x8140
#define INT_MASK_PKA1_SHIFT	8
#define TEGRA_SE_PKA1_CTRL_SE_INT_PKA1_MASK(x)	(x << INT_MASK_PKA1_SHIFT)

#define TEGRA_SE_PKA1_CTRL_SE_INT_STAT_OFFSET		0x813C
#define TEGRA_SE_PKA1_CTRL_SE_INT_STAT_ERR_SHIFT	16
#define TEGRA_SE_PKA1_CTRL_SE_INT_STAT_ERR(x)	\
			(x << TEGRA_SE_PKA1_CTRL_SE_INT_STAT_ERR_SHIFT)
