...
static noinline_for_stack bool gv11b_kind_supported(u8 k)
{
	return /* From gv11b */
		k == gmmu_pte_kind_c32_ms2_4cbra_v()
...
static noinline_for_stack bool gv11b_kind_z(u8 k)
{
	return /* From gv11b */
		(k == gmmu_pte_kind_c32_ms2_4cbra_v())
		|| (k == gmmu_pte_kind_c64_ms2_4cbra_v())
...
static noinline_for_stack bool gv11b_kind_c(u8 k)
{
...
static noinline_for_stack bool gv11b_kind_compressible(u8 k)
{
...
static noinline_for_stack bool gv11b_kind_zbc(u8 k)
{
