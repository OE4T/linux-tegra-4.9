...
#define NVL_SUBLINK_CHANGE_OLDSTATE_MASK_F(x)		(((x) & 0xf) << 16)
#define NVL_SUBLINK_CHANGE_OLDSTATE_MASK_DONTCARE	15
#define NVL_SUBLINK_CHANGE_COUNTDOWN_F(x)		(((x) & 0xfff) << 20)
#define NVL_SUBLINK_CHANGE_COUNTDOWN_IMMEDIATE		0
