...
static int tegra194_pinctrl_suspend(u32 *pg_data)
{
	return 0;
}

static void tegra194_pinctrl_resume(u32 *pg_data)
{
}

static int tegra194_gpio_request_enable(unsigned pin)
{
	return 0;
}
...
static const struct tegra_pinctrl_soc_data tegra194_pinctrl = {
	...
	.suspend = tegra194_pinctrl_suspend,
	.resume = tegra194_pinctrl_resume,
	.gpio_request_enable = tegra194_gpio_request_enable,
	.hsm_in_mux = false,
	.schmitt_in_mux = true,
	.drvtype_in_mux = true,
};
