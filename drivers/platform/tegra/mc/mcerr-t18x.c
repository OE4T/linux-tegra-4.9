...
irqreturn_t tegra_mc_error_hard_irq_ovr(int irq, void *data)
{
	...
	switch (g_instatus) {
		case 1 << INTSTATUS_CH0:
		case 1 << INTSTATUS_HUB0:
			mc_err_channel = 0;
			break;
		case 1 << INTSTATUS_CH1:
		case 1 << INTSTATUS_HUB1:
			mc_err_channel = 1;
			break;
		case 1 << INTSTATUS_CH2:
			mc_err_channel = 2;
			break;
		case 1 << INTSTATUS_CH3:
			mc_err_channel = 3;
			break;
		case 1 << INTSTATUS_BROADCAST:
			mc_err_channel = MC_BROADCAST_CHANNEL;
			break;
		default:
			trace_printk("mcerr: unknown source\n");
			return IRQ_NONE;
	}
	...
	mc_writel(g_instatus, MC_GLOBAL_INTSTATUS);
