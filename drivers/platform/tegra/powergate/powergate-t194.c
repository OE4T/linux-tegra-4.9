...
static struct pg_partition_info t194_partition_info[] = {
	...
	[TEGRA194_POWER_DOMAIN_PCIEX8AA] = { .name = "pciex8aa" },
	[TEGRA194_POWER_DOMAIN_PCIEX4AA] = { .name = "pciex4aa" },
	[TEGRA194_POWER_DOMAIN_PCIEX1AA] = { .name = "pciex1aa" },
	[TEGRA194_POWER_DOMAIN_NVL] = { .name = "nvl" },
	[TEGRA194_POWER_DOMAIN_PCIEX8BA] = { .name = "pciex8ba" },
