...
#define T19X_INT_XUSB			(163 + INT_OFFSET)
#define T19X_INT_SW_WAKE_TRIGGER	(19 + INT_OFFSET)
#define T19X_INT_AOVIC_FIQ		(206 + INT_OFFSET)
#define T19X_INT_AON_GPIO_0		(56 + INT_OFFSET)
#define T19X_INT_AON_GPIO_1		(57 + INT_OFFSET)
#define T19X_INT_VFMON			(200 + INT_OFFSET)
#define T19X_INT_AOPM			(216 + INT_OFFSET)
...
static int tegra19_wake_event_irq[] = {
	...
	T19X_INT_AOVIC_FIQ,	/* wake85 */
	-EAGAIN,		/* wake86 */
	T19X_INT_AON_GPIO_0,	/* wake87 */
	T19X_INT_AON_GPIO_1,	/* wake88 */
	T19X_INT_VFMON,		/* wake89 */
	T19X_INT_AOPM,		/* wake90 */
	-EAGAIN,		/* wake91 */
	INT_PMC2LIC,		/* wake92 */
	-EAGAIN,		/* wake93 */
	-EAGAIN,		/* wake94 */
