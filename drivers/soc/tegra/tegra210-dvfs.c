...
/* Per-bin Tables */
	...
	CORE_DVFS("vic03",		0, 0, 1, KHZ,	  38400,   38400,  153600,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200),
	CORE_DVFS("nvjpg",		0, 0, 1, KHZ,	  38400,   38400,  153600,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200),
	CORE_DVFS("se",			0, 0, 1, KHZ,	  38400,   38400,  153600,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200),
	CORE_DVFS("tsecb",		0, 0, 1, KHZ,	  38400,   38400,  153600,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200),
	CORE_DVFS("c2bus",		0, 0, 1, KHZ,	  38400,   38400,  153600,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200),

	CORE_DVFS("nvenc",		0, 0, 1, KHZ,	  38400,   38400,  326400,  384000,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400),
	CORE_DVFS("nvdec",		0, 0, 1, KHZ,	  38400,   38400,  326400,  384000,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400),
	CORE_DVFS("c3bus",		0, 0, 1, KHZ,	  38400,   38400,  326400,  384000,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400),

	CORE_DVFS("vi",			0, 0, 1, KHZ,	  38400,   38400,  364800,  384000,  422400,  460800,  499200,  518400,  556800,  595200,  652800,  691200,  748800,  806400,  940800, 1017600, 1075200),
	CORE_DVFS("cbus",		0, 0, 1, KHZ,	  38400,   38400,  364800,  384000,  422400,  460800,  499200,  518400,  556800,  595200,  652800,  691200,  748800,  806400,  940800, 1017600, 1075200),

	CORE_DVFS("abus",		0, 0, 1, KHZ,	      1,       1,  537600,  595200,  652800,  729600,  806400,  864000,  921600,  979200, 1036800, 1075200, 1132800, 1171200, 1248000, 1286400, 1324800),
	CORE_DVFS("aclk",		0, 0, 1, KHZ,	      1,       1,  537600,  595200,  652800,  729600,  806400,  864000,  921600,  979200, 1036800, 1075200, 1132800, 1171200, 1248000, 1286400, 1324800),

	CORE_DVFS("ape",		0, 0, 1, KHZ,	      1,       1,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("sbus",		0, 0, 1, KHZ,	      1,       1,  204000,  204000,  204000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000),
	CORE_DVFS("sclk",		0, 0, 1, KHZ,	      1,       1,  204000,  204000,  204000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000),

	CORE_DVFS("host1x",		0, 0, 1, KHZ,	      1,       1,  136000,  136000,  136000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("tsec",		0, 0, 1, KHZ,	      1,       1,  255045,  332332,  397906,  460552,  499838,  525983,  549467,  568960,  586974,  601844,  616461,  630292,  654745,  665766,  676702),
	CORE_DVFS("mselect",		0, 0, 1, KHZ,	      1,       1,  204000,  204000,  204000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000),

	CORE_DVFS("disp1",		0, 0, 0, KHZ,	      1,       1,  139875,  227539,  323330,  419140,  481198,  524222,  558885,  581514,  600645,  612344,  623984,  635498,  658472,  669772,  669772),
	CORE_DVFS("disp2",		0, 0, 0, KHZ,	      1,       1,  139875,  227539,  323330,  419140,  481198,  524222,  558885,  581514,  600645,  612344,  623984,  635498,  658472,  669772,  669772),

	/* Core voltages(mV):				    650,     675,     700,     725,     750,     775,     800,     825,     850,     875,     900,     925,     950,     975,    1000,    1025,    1050 */
	CORE_DVFS("emc",		0, 1, 1, KHZ,	      1,       1,       1,       1,       1,       1,       1,       1, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000),

	CORE_DVFS("vic03",		0, 1, 1, KHZ,	  38400,   38400,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200),
	CORE_DVFS("nvjpg",		0, 1, 1, KHZ,	  38400,   38400,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200),
	CORE_DVFS("se",			0, 1, 1, KHZ,	  38400,   38400,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200),
	CORE_DVFS("tsecb",		0, 1, 1, KHZ,	  38400,   38400,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200),
	CORE_DVFS("c2bus",		0, 1, 1, KHZ,	  38400,   38400,  268800,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200),

	CORE_DVFS("nvenc",		0, 1, 1, KHZ,	  38400,   38400,  384000,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400,  806400),
	CORE_DVFS("nvdec",		0, 1, 1, KHZ,	  38400,   38400,  384000,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400,  806400),
	CORE_DVFS("c3bus",		0, 1, 1, KHZ,	  38400,   38400,  384000,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400,  806400),

	CORE_DVFS("vi",			0, 1, 1, KHZ,	  38400,   38400,  384000,  422400,  460800,  499200,  518400,  556800,  595200,  652800,  691200,  748800,  806400,  940800, 1017600, 1075200, 1075200),
	CORE_DVFS("cbus",		0, 1, 1, KHZ,	  38400,   38400,  384000,  422400,  460800,  499200,  518400,  556800,  595200,  652800,  691200,  748800,  806400,  940800, 1017600, 1075200, 1075200),

	CORE_DVFS("abus",		0, 1, 1, KHZ,	      1,       1,  595200,  652800,  729600,  806400,  864000,  921600,  979200, 1036800, 1075200, 1132800, 1171200, 1248000, 1286400, 1324800, 1324800),
	CORE_DVFS("aclk",		0, 1, 1, KHZ,	      1,       1,  595200,  652800,  729600,  806400,  864000,  921600,  979200, 1036800, 1075200, 1132800, 1171200, 1248000, 1286400, 1324800, 1324800),

	CORE_DVFS("ape",		0, 1, 1, KHZ,	      1,       1,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("sbus",		0, 1, 1, KHZ,	      1,       1,  204000,  204000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000),
	CORE_DVFS("sclk",		0, 1, 1, KHZ,	      1,       1,  204000,  204000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000),

	CORE_DVFS("host1x",		0, 1, 1, KHZ,	      1,       1,  136000,  136000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("tsec",		0, 1, 1, KHZ,	      1,       1,  332332,  397906,  460552,  499838,  525983,  549467,  568960,  586974,  601844,  616461,  630292,  654745,  665766,  676702,  676702),
	CORE_DVFS("mselect",		0, 1, 1, KHZ,	      1,       1,  204000,  204000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000),
	CORE_DVFS("disp1",		0, 1, 1, KHZ,	      1,       1,  227539,  323330,  419140,  481198,  524222,  558885,  581514,  600645,  612344,  623984,  635498,  658472,  669772,  669772,  669772),
	CORE_DVFS("disp2",		0, 1, 1, KHZ,	      1,       1,  227539,  323330,  419140,  481198,  524222,  558885,  581514,  600645,  612344,  623984,  635498,  658472,  669772,  669772,  669772),

	/* Core voltages(mV):				    650,     675,     700,     725,     750,     775,     800,     825,     850,     875,     900,     925,     950,     975,    1000,    1025,    1050 */
	CORE_DVFS("emc",		0, 2, 1, KHZ,	      1,       1,       1,       1,       1,       1,       1,       1, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000, 1600000),

	CORE_DVFS("vic03",		0, 2, 1, KHZ,	  38400,   38400,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200,  595200),
	CORE_DVFS("nvjpg",		0, 2, 1, KHZ,	  38400,   38400,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200,  595200),
	CORE_DVFS("se",			0, 2, 1, KHZ,	  38400,   38400,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200,  595200),
	CORE_DVFS("tsecb",		0, 2, 1, KHZ,	  38400,   38400,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200,  595200),
	CORE_DVFS("c2bus",		0, 2, 1, KHZ,	  38400,   38400,  345600,  422400,  480000,  499200,  518400,  537600,  537600,  556800,  556800,  576000,  595200,  595200,  595200,  595200,  595200),

	CORE_DVFS("nvenc",		0, 2, 1, KHZ,	  38400,   38400,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400,  806400,  806400),
	CORE_DVFS("nvdec",		0, 2, 1, KHZ,	  38400,   38400,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400,  806400,  806400),
	CORE_DVFS("c3bus",		0, 2, 1, KHZ,	  38400,   38400,  441600,  499200,  556800,  614400,  652800,  691200,  710400,  729600,  748800,  748800,  787200,  787200,  806400,  806400,  806400),

	CORE_DVFS("vi",			0, 2, 1, KHZ,	  38400,   38400,  422400,  460800,  499200,  518400,  556800,  595200,  652800,  691200,  748800,  806400,  940800, 1017600, 1075200, 1075200, 1075200),
	CORE_DVFS("cbus",		0, 2, 1, KHZ,	  38400,   38400,  422400,  460800,  499200,  518400,  556800,  595200,  652800,  691200,  748800,  806400,  940800, 1017600, 1075200, 1075200, 1075200),

	CORE_DVFS("abus",		0, 2, 1, KHZ,	      1,       1,  652800,  729600,  806400,  864000,  921600,  979200, 1036800, 1075200, 1132800, 1171200, 1248000, 1286400, 1324800, 1324800, 1324800),
	CORE_DVFS("aclk",		0, 2, 1, KHZ,	      1,       1,  652800,  729600,  806400,  864000,  921600,  979200, 1036800, 1075200, 1132800, 1171200, 1248000, 1286400, 1324800, 1324800, 1324800),

	CORE_DVFS("ape",		0, 2, 1, KHZ,	      1,       1,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("sbus",		0, 2, 1, KHZ,	      1,       1,  204000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000),
	CORE_DVFS("sclk",		0, 2, 1, KHZ,	      1,       1,  204000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000,  300000),

	CORE_DVFS("host1x",		0, 2, 1, KHZ,	      1,       1,  136000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("tsec",		0, 2, 1, KHZ,	      1,       1,  397906,  460552,  499838,  525983,  549467,  568960,  586974,  601844,  616461,  630292,  654745,  665766,  676702,  676702,  676702),
	CORE_DVFS("mselect",		0, 2, 1, KHZ,	      1,       1,  204000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000,  310000),
	CORE_DVFS("disp1",		0, 2, 1, KHZ,	      1,       1,  323330,  419140,  481198,  524222,  558885,  581514,  600645,  612344,  623984,  635498,  658472,  669772,  669772,  669772,  669772),
	CORE_DVFS("disp2",		0, 2, 1, KHZ,	      1,       1,  323330,  419140,  481198,  524222,  558885,  581514,  600645,  612344,  623984,  635498,  658472,  669772,  669772,  669772,  669772),

/* Common Tables */
	/* Core voltages(mV):				    650,     675,     700,     725,     750,     775,     800,     825,     850,     875,     900,     925,     950,     975,    1000,    1025,    1050 */
	CORE_DVFS("pll_a",		-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_c",		-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_c2",		-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_c3",		-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_c4_out0",	-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_d_out0",		-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_d2",		-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_dp",		-1, -1, 1, KHZ,	      1,       1, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000),
	...
	CORE_DVFS("cilab",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("cilcd",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("cile",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),

	CORE_DVFS("dsia",		-1, -1, 1, KHZ,	 500000,  500000,  500000,  500000,  500000,  500000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000),
	CORE_DVFS("dsib",		-1, -1, 1, KHZ,	 500000,  500000,  500000,  500000,  500000,  500000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000),
	...
	CORE_DVFS("sor0",		-1, -1, 1, KHZ,	 162000,  162000,  270000,  270000,  270000,  270000,  270000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000),
	CORE_DVFS("sor1",		-1, -1, 1, KHZ,	 148500,  148500,  297000,  297000,  297000,  297000,  297000,  297000,  297000,  594000,  594000,  594000,  594000,  594000,  594000,  594000,  594000),
	...
	CORE_DVFS("d_audio",		-1, -1, 1, KHZ,	  49152,   49152,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304),
	CORE_DVFS("spdif_out",		-1, -1, 1, KHZ,	  24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24728,   24728,   24728,   24728,   24728,   24728,   24728,   24728,   24728),
	...
	CORE_DVFS("sdmmc2",		-1, -1, 1, KHZ,	      1,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("sdmmc4",		-1, -1, 1, KHZ,	      1,  200000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000),
	CORE_DVFS("sdmmc2_ddr",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("sdmmc4_ddr",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),

	CORE_DVFS("sdmmc1",		-1, -1, 1, KHZ,	 136000,  136000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("sdmmc3",		-1, -1, 1, KHZ,	 136000,  136000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),

	CORE_DVFS("sdmmc1_ddr",		-1, -1, 1, KHZ,	  96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000),
	CORE_DVFS("sdmmc3_ddr",		-1, -1, 1, KHZ,	  96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000),

	CORE_DVFS("xusb_falcon_src",	-1, -1, 1, KHZ,	      1,       1,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000),
	CORE_DVFS("xusb_host_src",	-1, -1, 1, KHZ,	      1,       1,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000),
	CORE_DVFS("xusb_dev_src",	-1, -1, 1, KHZ,	      1,       1,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000),
	CORE_DVFS("xusb_ssp_src",	-1, -1, 1, KHZ,	      1,       1,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000),
	CORE_DVFS("xusb_fs_src",	-1, -1, 1, KHZ,	      1,       1,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000),
	CORE_DVFS("xusb_hs_src",	-1, -1, 1, KHZ,	      1,       1,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000),
	...
	CORE_DVFS("sata",		-1, -1, 1, KHZ,	      1,       1,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("sata_oob",		-1, -1, 1, KHZ,	      1,       1,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("pcie",		-1, -1, 1, KHZ,	      1,       1,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000),
...
static struct dvfs sor1_dpb01_dvfs_table[] = {
	CORE_DVFS("sor1",		-1, -1, 1, KHZ,	 162000,  162000,  270000,  270000,  270000,  270000,  270000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000),
};

static struct dvfs spib01_dvfs_table[] = {
	CORE_DVFS("sbc1",		-1, -1, 1, KHZ,	  12000,   35000,   50000,   50000,   50000,   50000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
	CORE_DVFS("sbc2",		-1, -1, 1, KHZ,	  12000,   35000,   50000,   50000,   50000,   50000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
	CORE_DVFS("sbc3",		-1, -1, 1, KHZ,	  12000,   35000,   50000,   50000,   50000,   50000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
	CORE_DVFS("sbc4",		-1, -1, 1, KHZ,	  12000,   35000,   50000,   50000,   50000,   50000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
...
static struct dvfs qspi_sdrb01_dvfs_table[] = {
	CORE_DVFS("qspi",		-1, -1, 1, KHZ,	  81600,   81600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600),
};
