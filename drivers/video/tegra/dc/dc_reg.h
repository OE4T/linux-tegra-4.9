...
#if defined(CONFIG_TEAGRA_DC_64BIT_SUPPROT)
...
#if defined(CONFIG_TGRA_DC_64BIT_SUPPORT)
...
#if defined(CONFIG_TGRA_DC_64BIT_SUPPORT)
#define DC_WINBUF_START_ADDR_FILED2_HI	0x819
#define DC_WINBUF_START_ADDR_FILED2_HI_U	0x81b
#define DC_WINBUF_START_ADDR_FILED2_HI_V	0x81d
#endif
