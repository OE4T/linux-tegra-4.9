...
#define TEGRA_WIN_FMT_T186_W0 (TEGRA_WIN_FMT_BASE | \
				BIT(TEGRA_WIN_FMT_T_R4G4B4A4))
#define TEGRA_WIN_FMT_T186_W1 TEGRA_WIN_FMT_T124_HIGH
#define TEGRA_WIN_FMT_T186_W2 (BITWORD2(TEGRA_WIN_FMT_T_A2R10G10B10) | \
...
/* window 4 */
	...
	{ 4, TEGRA_DC_FEATURE_INVERT_TYPE, {1, 1, 1} },
	{ 4, TEGRA_DC_FEATURE_FIELD_TYPE, {1} },
	{ 4, TEGRA_DC_FEATURE_COMPRESSION_FORMATS, {0, 0} },
	/* cannot rotate planar format */
	{ 4, TEGRA_DC_FEATURE_PLANAR_ROTATION_MAXIMUM_SIZE, {0, 0, 0, 0} },
...
/* window 5 */
	...
	{ 5, TEGRA_DC_FEATURE_MAXIMUM_SIZE, {4096, 1, 4096, 1} },
	{ 5, TEGRA_DC_FEATURE_MAXIMUM_SCALE, {2, 2, 2, 2} },
	{ 5, TEGRA_DC_FEATURE_FILTER_TYPE, {1, 1} },
	{ 5, TEGRA_DC_FEATURE_LAYOUT_TYPE, {1, 0, 1} },
	{ 5, TEGRA_DC_FEATURE_INVERT_TYPE, {1, 1, 1} },
	{ 5, TEGRA_DC_FEATURE_FIELD_TYPE, {1} },
	{ 5, TEGRA_DC_FEATURE_COMPRESSION_FORMATS, {0, 0} },
	/* cannot rotate planar format */
	{ 5, TEGRA_DC_FEATURE_PLANAR_ROTATION_MAXIMUM_SIZE, {0, 0, 0, 0} },
