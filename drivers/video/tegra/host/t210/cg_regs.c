...
static struct nvhost_gating_register t21x_nvenc_gating_registers[] = {
	...
	{ .addr = 0x0000117c, .prod = 0x00030008, .disable = 0x0003fffe },
	/* NV_PNVENC_CG2 */
	{ .addr = 0x00002200, .prod = 0x00800040, .disable = 0xffffffff },
	/* NV_PNVENC_CG3 */
...
static struct nvhost_gating_register t21x_tsec_gating_registers[] = {
	...
	/* NV_PSEC_FALCON_CG2 */
	{ .addr = 0x0000117c, .prod = 0x00000000, .disable = 0x0003fffe },
	{}
};

static struct nvhost_gating_register t21x_nvjpg_gating_registers[] = {
...
static struct nvhost_gating_register t21x_vic_gating_registers[] = {
	...
	{ .addr = 0x00001604, .prod = 0x00000000, .disable = 0x00000000 },
	/* NV_PVIC_FALCON_CG2 */
	{ .addr = 0x00001134, .prod = 0x00000000, .disable = 0x00000003 },
	/* NV_PVIC_FALCON_CG1_SLCG */
	{ .addr = 0x0000117c, .prod = 0x00000000, .disable = 0x00000003 },
	{}
};

static struct nvhost_gating_register t21x_nvdec_gating_registers[] = {
