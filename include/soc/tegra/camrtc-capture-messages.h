 ...
 */
#define CAPTURE_CHANNEL_SETUP_REQ		0x10
#define CAPTURE_CHANNEL_SETUP_RESP		0x11
#define CAPTURE_CHANNEL_RESET_REQ		0x12
#define CAPTURE_CHANNEL_RESET_RESP		0x13
#define CAPTURE_CHANNEL_RELEASE_REQ		0x14
#define CAPTURE_CHANNEL_RELEASE_RESP		0x15
#define CAPTURE_COMPAND_CONFIG_REQ		0x16
#define CAPTURE_COMPAND_CONFIG_RESP		0x17
#define CAPTURE_PDAF_CONFIG_REQ			0x18
#define CAPTURE_PDAF_CONFIG_RESP		0x19
#define CAPTURE_SYNCGEN_ENABLE_REQ		0x1A
#define CAPTURE_SYNCGEN_ENABLE_RESP		0x1B
#define CAPTURE_SYNCGEN_DISABLE_REQ		0x1C
#define CAPTURE_SYNCGEN_DISABLE_RESP		0x1D

/**
 * Message types for capture channel messages.
 */
#define	CAPTURE_REQUEST_REQ			0x01
#define	CAPTURE_STATUS_IND			0x02

/**
 * Invalid message type. This can be used to
 * respond to an invalid request.
 */
#define CAPTURE_MSG_ID_INVALID			0xFFFFFFFF

/**
 * Result codes.
 */
#define CAPTURE_OK				0
#define CAPTURE_ERROR_INVALID_PARAMETER		1
#define CAPTURE_ERROR_NO_MEMORY			2
#define CAPTURE_ERROR_BUSY			3
#define CAPTURE_ERROR_NOT_SUPPORTED		4
#define CAPTURE_ERROR_NOT_INITIALIZED		5
#define CAPTURE_ERROR_OVERFLOW			6
#define CAPTURE_ERROR_NO_RESOURCES		7
...
#define CAPTURE_CHANNEL_RESET_FLAG_IMMEDIATE	0x01
...
#define CAPTURE_SYNCGEN_DISABLE_FLAG_IMMEDIATE	0x01
